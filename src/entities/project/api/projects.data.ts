...
export const destaques: CuratedProject[] = [
  { id: "escola-de-programacao", title: "Escola de Programação", description: "Catálogo digital para criar conteúdos de programação — Hub de Projetos.", status: "mvp", tipo: "projeto", category: "top", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/escola-de-programacao/blob/main/readme.md" }] },
  { id: "ux-design", title: "UX Design", description: "Template institucional para um estúdio ou agência de UX design.", status: "mvp", tipo: "educacional", category: "top", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/ux-design" }] },
  { id: "em-desenvolvimento-card", title: "Em Desenvolvimento", description: "Card indicando projeto que ainda não possui repositório público vinculado.", status: "em-desenvolvimento", tipo: "projeto", category: "top", links: [] },
];
...
export const mvpRepos: CuratedProject[] = [
  ...
  { id: "calculadora", title: "Calculadora", description: "Calculadora básica, exercício de lógica de programação.", status: "mvp", tipo: "educacional", category: "mvp", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/calculadora" }] },
  { id: "signature-generator", title: "Signature Generator", description: "Gerador de assinaturas profissionais para e-mails.", status: "em-desenvolvimento", tipo: "utilitario", category: "mvp", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/signature-generator" }] },
  { id: "biblioteca", title: "Biblioteca", description: "Catálogo de títulos de livros e obras preferidas.", status: "em-desenvolvimento", tipo: "projeto", category: "mvp", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/biblioteca" }] },
...
export const projetosOriginais: CuratedProject[] = [
  { id: "jobs-calc", title: "Jobs Calc", description: "Estimativa de custo para projetos freelancer, com cadastro e exclusão de jobs.", status: "em-desenvolvimento", tipo: "utilitario", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/jobs-calc" }] },
  { id: "rocket-q", title: "Rocket Q", description: "Salas de perguntas para internautas anônimos, com o criador gerenciando e marcando como lidas.", status: "em-desenvolvimento", tipo: "educacional", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/rocket-q" }] },
  ...
  { id: "movies", title: "Movies", description: "Aplicação para visualizar filmes conforme regras de negócio.", status: "em-desenvolvimento", tipo: "utilitario", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/movies" }] },
  { id: "proffy", title: "Proffy", description: "Cadastro de aulas com horário e conteúdo, permitindo interação com possíveis alunos.", status: "em-desenvolvimento", tipo: "educacional", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/proffy" }] },
  ...
  { id: "casa-criativa", title: "Casa Criativa", description: "Aplicação para cadastrar ideias.", status: "em-desenvolvimento", tipo: "utilitario", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/casa-criativa" }] },
  ...
  { id: "todo-app", title: "Todo App", description: "To-do list com fluxo CRUD.", status: "em-desenvolvimento", tipo: "educacional", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/todo-app" }] },
  ...
  { id: "marvel", title: "Marvel", description: "Site institucional temático.", status: "mvp", tipo: "educacional", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/marvel" }] },
  ...
  { id: "oxe-online", title: "Oxe Online", description: "Processo seletivo digital.", status: "em-desenvolvimento", tipo: "utilitario", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/oxe-online" }] },
  ...
  { id: "cm-quiz-app", title: "CM Quiz App", description: "Quiz multiplayer personalizado para um evento de feira de ciências.", status: "em-desenvolvimento", tipo: "educacional", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/cm-quiz-app" }] },
  { id: "biblia", title: "Bíblia", description: "API REST em PHP com MySQL.", status: "em-desenvolvimento", tipo: "educacional", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/biblia" }] },
  ...
  { id: "be-the-hero", title: "Be the Hero", description: "Cadastro de heróis que podem contribuir acessando o perfil.", status: "em-desenvolvimento", tipo: "educacional", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/be-the-hero" }] },
  ...
  { id: "feedback-widget", title: "Feedback Widget", description: "Widget que pode ser usado em aplicações web e mobile para feedback.", status: "mvp", tipo: "utilitario", category: "projetos", links: [{ label: "Repositório", url: "https://github.com/douglasabnovato/feedback-widget" }] },
];
